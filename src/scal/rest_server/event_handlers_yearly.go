...
func AddYearly(w http.ResponseWriter, r *auth.AuthenticatedRequest) {
    ...
    sameEventModel := event_lib.YearlyEventModel{} // DYNAMIC
    // -----------------------------------------------
    email := r.Username
...
func GetYearly(w http.ResponseWriter, r *auth.AuthenticatedRequest) {
    eventModel := event_lib.YearlyEventModel{}
    // -----------------------------------------------
    email := r.Username
...
func PatchYearly(w http.ResponseWriter, r *auth.AuthenticatedRequest) {
    ...
    }
    {
        ...
        if ok {
            ...
            eventModel.Month = int(newValue)
            
            delete(patchMap, "month")
        }
    }
    {
        value, ok := patchMap["day"]
        if ok {
            ...
            eventModel.Day = int(newValue)
            
            delete(patchMap, "day")
        }
    }
    {
        value, ok := patchMap["startYear"]
        if ok {
            ...
            eventModel.StartYear = int(newValue)
            
            delete(patchMap, "startYear")
        }
    }
    {
        value, ok := patchMap["startYearEnable"]
        if ok {
            ...
            eventModel.StartYearEnable = newValue
