...
//
//go:generate $GOPATH/pkg/scal/rest_server/gen -event-type yearly
package api_v1
...
func AddYearly(req rp.Request) (*rp.Response, error) {
...
func GetYearly(req rp.Request) (*rp.Response, error) {
...
func UpdateYearly(req rp.Request) (*rp.Response, error) {
	userModel, err := CheckAuth(req)
	if err != nil {
		return nil, err
	}
...
func PatchYearly(req rp.Request) (*rp.Response, error) {
	userModel, err := CheckAuth(req)
	if err != nil {
		return nil, err
	}
...
func MergeYearly(req rp.Request) (*rp.Response, error) {
	userModel, err := CheckAuth(req)
	if err != nil {
		return nil, err
	}
