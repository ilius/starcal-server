	...
	routeGroups = append(routeGroups, RouteGroup{
		...
		Map: RouteMap{
			"AddMonthly": {
				Method:      "POST",
				Pattern:     "",
				HandlerFunc: authWrap(AddMonthly),
			},
			"GetMonthly": {
				Method:      "GET",
				Pattern:     "{eventId}",
				HandlerFunc: authWrap(GetMonthly),
			},
			"UpdateMonthly": {
				Method:      "PUT",
				Pattern:     "{eventId}",
				HandlerFunc: authWrap(UpdateMonthly),
			},
			"PatchMonthly": {
				Method:      "PATCH",
				Pattern:     "{eventId}",
				HandlerFunc: authWrap(PatchMonthly),
			},
			"MergeMonthly": {
				Method:      "POST",
				Pattern:     "{eventId}/merge",
				HandlerFunc: authWrap(MergeMonthly),
			},
...
func AddMonthly(w http.ResponseWriter, r *http.Request) {
	defer r.Body.Close()
...
func UpdateMonthly(w http.ResponseWriter, r *http.Request) {
	defer r.Body.Close()
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	userModel := CheckAuthGetUserModel(w, r)
	if userModel == nil {
...
func PatchMonthly(w http.ResponseWriter, r *http.Request) {
	defer r.Body.Close()
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	userModel := CheckAuthGetUserModel(w, r)
	if userModel == nil {
...
func MergeMonthly(w http.ResponseWriter, r *http.Request) {
	defer r.Body.Close()
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	userModel := CheckAuthGetUserModel(w, r)
	if userModel == nil {
