...
//
//go:generate $GOPATH/pkg/scal/rest_server/gen -event-type universityClass
package api_v1
...
func AddUniversityClass(req rp.Request) (*rp.Response, error) {
...
func GetUniversityClass(req rp.Request) (*rp.Response, error) {
...
func UpdateUniversityClass(req rp.Request) (*rp.Response, error) {
	userModel, err := CheckAuth(req)
	if err != nil {
		return nil, err
	}
...
func PatchUniversityClass(req rp.Request) (*rp.Response, error) {
	userModel, err := CheckAuth(req)
	if err != nil {
		return nil, err
	}
...
func MergeUniversityClass(req rp.Request) (*rp.Response, error) {
	userModel, err := CheckAuth(req)
	if err != nil {
		return nil, err
	}
