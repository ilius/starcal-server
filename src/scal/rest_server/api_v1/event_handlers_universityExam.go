...
func init() {
	routeGroups = append(routeGroups, RouteGroup{
		Base: "event/universityExam",
		Map: RouteMap{
			"AddUniversityExam": {
				Method:      "POST",
				Pattern:     "",
				HandlerFunc: authWrap(AddUniversityExam),
			},
			"GetUniversityExam": {
				Method:      "GET",
				Pattern:     "{eventId}",
				HandlerFunc: authWrap(GetUniversityExam),
			},
			"UpdateUniversityExam": {
				Method:      "PUT",
				Pattern:     "{eventId}",
				HandlerFunc: authWrap(UpdateUniversityExam),
			},
			"PatchUniversityExam": {
				Method:      "PATCH",
				Pattern:     "{eventId}",
				HandlerFunc: authWrap(PatchUniversityExam),
			},
			"MergeUniversityExam": {
				Method:      "POST",
				Pattern:     "{eventId}/merge",
				HandlerFunc: authWrap(MergeUniversityExam),
			},
...
func AddUniversityExam(w http.ResponseWriter, r *http.Request) {
	defer r.Body.Close()
...
func GetUniversityExam(w http.ResponseWriter, r *http.Request) {
	defer r.Body.Close()
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	userModel := CheckAuthGetUserModel(w, r)
	if userModel == nil {
	...
	eventModel.Id = *eventId
	eventModel.DummyType = eventMeta.EventType  // not "universityExam"
...
func UpdateUniversityExam(w http.ResponseWriter, r *http.Request) {
	defer r.Body.Close()
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	userModel := CheckAuthGetUserModel(w, r)
	if userModel == nil {
...
func PatchUniversityExam(w http.ResponseWriter, r *http.Request) {
	defer r.Body.Close()
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	userModel := CheckAuthGetUserModel(w, r)
	if userModel == nil {
...
func MergeUniversityExam(w http.ResponseWriter, r *http.Request) {
	defer r.Body.Close()
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	userModel := CheckAuthGetUserModel(w, r)
	if userModel == nil {
